...
<html lang="en">
    ...
    <body  style="margin-left: 10%; margin-right: 10%; background-image: url(../../../../../../IMG/fondo1.jpeg); background-repeat: no-repeat; background-size: cover ">
        ...
        <div class="Contenido">
            ...
            <h1>EJERCICIOS ARMONICOS CALIFICABLES</h1>
            
            <p>Vamos a realizar un examen para poder evaluar tu progreso frente a los temas
            vistos en el modulo de armonia, esto con el fin de verificar los conocimientos 
            adquiridos por parte del estudiante. </p>
            
            <div class="links">
                
                <div class="contenedorLinks1">
                    
                     <a class="Link1" href="url"> PDF EXAMEN PRESENCIAL</a>
                    
                </div>
                <div class="contenedorLinks2">
                    
                    <a class="Link2" href="url">PRUEBA DE CONOCIMIENTOS ARMONIA</a>
                </div>
            ...
            <img src="../../../../../../IMG/examen4.jpeg" class="imagenCentral1 rounded float-start" alt="..." style=" width: 72%; margin-left: 17%;">
