...
<html lang="en">
    ...
    <body  style="margin-left: 10%; margin-right: 10%; background-image: url(../../../../../../IMG/fondo1.jpeg); background-repeat: no-repeat; background-size: cover ">
        ...
        <h1 class="Titulo">Partitura Nivel 1</h1>
        ...
        <div class="Contenido">
            ...
            <p  class="TextoContenido">
               ...
               Una partitura es un documento manuscrito o impreso que representa
               e indica como debe interpretarse una composicion musical, mediante un lenguaje propio 
               formado por signos musicales y el llamado sistema de notacion.
               
               <br><!-- comment -->
               
               Se utilizan simbolos de musica moderna para indicar las melodias, ritmos y acordes de
               una cancion o pieza instrumental.
                
            </p>

             <h2 class="text-center">ANALIZAMOS UNA MELODIA</h2>
            
            
            <p  class="TextoContenido">
                
                Una melodia es una sucesion de sonidos individuales que percibimos
                como un todo reconocible: Una sucesion coherente de notas, con las alturas/notas
                de la melodia nos relacionamos de la misma forma nosotros escuchamos los sonidos en 
                una frase: no por separado. Sino como un pensamiento. 
                
            </p> 
            
            <img src="../../../../../../IMG/Prtirura1.jpeg" class="imagenCentral rounded float-end w-50 h-100" alt="...">
