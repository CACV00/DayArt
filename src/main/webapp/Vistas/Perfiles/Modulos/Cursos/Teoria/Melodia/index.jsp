...
<html lang="en">
    ...
    <body  style="margin-left: 10%; margin-right: 10%; background-image: url(../../../../../../IMG/fondo1.jpeg); background-repeat: no-repeat; background-size: cover ">
        ...
        <h1 class="Titulo">MELODIA</h1>

        <div class="Contenido">

            <p>
            
                En este modulo de teoria musical el estudiante aprendera bases
                sobre la melodia, tales como la profundizacion en melodia, melodia instrumental
                , vocal y cadencias, de igual forma se les asignara un taller de practica con 
                intervalos para que puedan aprender de forma autonoma, culminando con una prueba 
                de conocimiento sobre el tema a tratar
