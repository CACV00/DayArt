...
<html lang="en">
    ...
    <body  style="margin-left: 10%; margin-right: 10%; background-image: url(../../../../../../IMG/fondo1.jpeg); background-repeat: no-repeat; background-size: cover ">
        ...
        <h1 class="Titulo">Melodia Nivel 4</h1>
        ...
        <div class="Contenido">
            ...
            <h1>EJERCICIOS MELODICOS CALIFICABLES</h1>
            
            <p class="textoLateral1" >
            
                A continuacion realizaremos un examen respecto a los temas vistos
                en este modulo de melodia con el fin de evaluar los conocimientos adquiridos por parte del 
                estudiante 
            ...
            <div class="links">
                ...
                <div class="contenedorLinks2">
                    ...
                    <a class="Link2" href="url">PRUEBA DE CONOCIMIENTOS MELODIA</a>
                </div>
            ...
            <img src="../../../../../../IMG/MELODIA41.jpeg" class="imagenCentral1 rounded float-start" alt="..." style=" width: 72%; margin-left: 17%;">
