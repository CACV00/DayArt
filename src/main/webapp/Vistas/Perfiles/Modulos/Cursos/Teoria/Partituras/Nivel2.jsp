...
<html lang="en">
    ...
    <body  style="margin-left: 10%; margin-right: 10%; background-image: url(../../../../../../IMG/fondo1.jpeg); background-repeat: no-repeat; background-size: cover ">
        ...
        <h1 class="Titulo">Partitura Nivel 2</h1>
        ...
        <div class="Contenido">
            ...
            <p  class="TextoContenido">
               ...
               Aprenderan los estudiantes a leer las notas DO, RE, MI, FA, SOL, LA, SI, las figuras Redonda, 
               Blanca, Nera... entre otras.
                
            </p>

             
            
            <img src="../../../../../../IMG/IMGMAESTRO/clave-de-fa.jpg" class="imagenCentral rounded float-end w-50 h-100" alt="...">
            <h2 class="text-center">EJERCICIOS DE SLFEO CLAVE DE SOLY CLAVE DE FA</h2>
            <img src="../../../../../../IMG/IMGMAESTRO/MelodiaNivel2img2.jpg" class="imagenCentral rounded float-end w-50 h-100" alt="...">
            
            <h1>QUE ES UNA ARMADURA</h1>
            
            <p  class="TextoContenido">

                   En la notacion musical, la armadura de tonalidad tambien llamada
               armadura de clave o simplemente armadura, es el conjunto de alteraciones
               propias de la escala que escritas despues de la clave y al principio 
               del pentagrama, situan una frase musical en la tonalidad.

            </p>
            
            <img src="../../../../../../IMG/IMGMAESTRO/ARMADURA.jpg" class="imagenCentral rounded float-end w-50 h-100" alt="...">
        ...
        <div class="d-flex justify-content-between bd-highlight mb-3 mt-5" style="background-color: black;">
            <div class="p-2 bd-highlight">
                ...
                <img src="../../../../../../IMG/logomarcadeagua.png" class=" rounded float-end" alt="...">
