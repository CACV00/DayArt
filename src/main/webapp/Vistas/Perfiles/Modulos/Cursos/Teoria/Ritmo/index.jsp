...
<html lang="en">
    ...
    <body  style="margin-left: 10%; margin-right: 10%; background-image: url(../../../../../../../IMG/fondo1.jpeg); background-repeat: no-repeat; background-size: cover ">
        ...
        <h1 class="Titulo">RITMO</h1>

        <div class="Contenido">

            <p>En este modulo de teoria musical el estudiante aprendera bases sobre el ritmo tales como 
            el pulso, identificacion de notas musicales segun su velocidad y compaces, de igual forma se 
            les asignara un taller de practica pra que puedan aprender de forma autonoma, culminado con 
            una prueba de conocimiento sobre el tema a tratar</p>
