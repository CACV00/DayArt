...
<html lang="en">
    ...
    <body  style="margin-left: 10%; margin-right: 10%; background-image: url(../../../../../../IMG/fondo1.jpeg); background-repeat: no-repeat; background-size: cover ">
        ...
        <h1 class="Titulo">Melodia Nivel 2</h1>
        ...
        <div class="Contenido">
            ...
            <h1 class="TituloContenido text-center">MELODIAS INSTRUMENTALES</h1>

            <p  class="TextoContenido">

                Cuando se trata de musica popular, nada es  definitivo que las melodias vocales:
                <br>
                <br>
                Todos los aspectos de la musica pueden conectar con los oyentes, pero las voces
                son las partes con las que mas nos relacionamos en las canciones.


            </p><!-- comment -->

            <h1 class="text-center">MELODIAS VOCALES</h1>

            <p  class="TextoContenido">

                En musica, la cadencia es una serie de acordes o termula de melodia que suele
                coincidir con el fin de una seccion en una obra. Una cadencia es una funcion
                armonica y formal caracterizada por una progresion (o encadenamiento) de
                acordes que suele desembocar en el acorde de tenica o acorde base.

            </p>

            <h1 class="text-center">CADENCIA</h1>

            <p  class="TextoContenido">

                Las melodias instrumentales se producen en instrumentos que producen notas.
                Partes como riffs, solos y lineas que responden a la voz en una cancion son
                ejemplos de melogias instrumentales.
            ...
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <img src="../../../../../../IMG/MELODIA224.jpeg" class="imagenlateral rounded float-end w-75 h-100" alt="...">

                    
                </div>
                <div class="col-4">
                    
                    <img src="../../../../../../IMG/niñoviolin.jpg" class="rounded float-end w-50 h-100" alt="...">
            ...
            <img src="../../../../../../IMG/MELODIA223.jpeg" class="imagenlateral1 rounded float-end w-50 h-100" alt="...">
