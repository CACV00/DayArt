...
<html lang="en">
    ...
    <body  style="margin-left: 10%; margin-right: 10%; background-image: url(../../../../../../IMG/fondo1.jpeg); background-repeat: no-repeat; background-size: cover ">
        ...
        <h1 class="Titulo">Armonia Nivel 2</h1>
        ...
        <div class="Contenido">
            ...
            <h1>TONO Y SEMITONO</h1>
            
            <p>Un tono equivale a dos semitonos y estos equivalen a la distancia en 
                frecuencia que hay entre cada uno de los sonidos, es decir, el intervalo 
                que existe entre dos notas.

                Por ejemplo:
                De Do a Mi hay 2 tonos</p>
            
            <img src="../../../../../../IMG/armonia21.jpeg" class="rounded float-start " alt="..." style=" width: 72%; margin-left: 17%;">
            
            <h1>INTERVALOS</h1>
            
            <p>Intervalo es la distancia entre dos notas musicales o entre dos sonidos. 
                En general, suelen medirse segun las notas de una escala incluyendo los 
                extremos, o bien por la diferencia de tonos y semitonos, o solamente de 
                sentidos. Por ejemplo, una quinta justa es un intervalo de 7 semitonos.</p>
            
            <img src="../../../../../../IMG/armonia22.jpeg" class="rounded float-start " alt="..." style=" width: 72%; margin-left: 17%;">
