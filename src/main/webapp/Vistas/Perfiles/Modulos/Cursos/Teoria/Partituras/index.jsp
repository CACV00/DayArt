...
<html lang="en">
    ...
    <body  style="margin-left: 10%; margin-right: 10%; background-image: url(../../../../../../IMG/fondo1.jpeg); background-repeat: no-repeat; background-size: cover ">
        ...
        <h1 class="Titulo">PARTITURAS</h1>

        <div class="Contenido">

            <p>
           
                En este modulo de teoria musical el estudiante 
                aprendera bases de partitura, esto teniendo en cuenta que el 
                estudiante ya tiene el conocimiento sobre los temas anteriores a tratar
                los cuales son: ritmo, melodia y armonia, con el fin de que pueda comprender
                este modulo, se abarcan los temas de tipos de partituras y armaduras, de igual
                forma se les asignara un taller de practica.
            </p>
